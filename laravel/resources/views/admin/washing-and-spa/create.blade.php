    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Form New Washing and Spa</h3>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-success">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.washing-and-spa.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="name" required type="text" id="name" class="form-control"
                                                   placeholder="Enter washing and spa name">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Enter medicine description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="street" required type="text" id="street" class="form-control"
                                                   placeholder="Enter street of washing and spa">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="districts" required type="text" id="districts" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" required name="city" id="city" class="form-control" placeholder="Enter city of washing and spa">
                                            </div>
                                        </div>
                                    </div>
                                </div>
