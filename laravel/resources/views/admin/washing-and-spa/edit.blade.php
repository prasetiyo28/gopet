    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Form Edit Washing and Spa</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.washing-and-spa') }}">Washing and Spa</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-success">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.washing-and-spa.update', $washingAndSpa->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="form-body">
                                <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input name="image" data-max-file-size="1M" type="file"
                                                               data-default-file="{{ asset('/images/'.$washingAndSpa->image) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Washing and Spa Name <span
                                                        class="text-danger">*</span></label>
                                            <input name="name" required type="text" id="name" class="form-control"
                                                   value="{{ $washingAndSpa->name }}" placeholder="Enter washing and spa name">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control" cols="30"
                                                      rows="10" placeholder="Enter medicine description">{{ $washingAndSpa->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="street" required type="text" id="street" class="form-control"
                                                   placeholder="Enter street of washing and spa" value="{{ $washingAndSpa->street }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="districts" required type="text" id="districts"
                                                   class="form-control" value="{{ $washingAndSpa->districts }}"
                                                   placeholder="Enter districts of washing and spa">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" required name="city" id="city" class="form-control"
                                                       placeholder="Enter city of washing and spa" value="{{ $washingAndSpa->city }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
