        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 col-4 align-self-center">
                <div class="d-flex m-t-10 justify-content-end">
                    <a href="{{ route('admin.medicine.create') }}" class="btn btn-outline-success btn-sm">
                        <i class="fa fa-plus"></i>&ensp;New Medicine</a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                @foreach($medicines as $key => $medicine)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('images/' . $medicine->image) }}" alt="food"
                                        ...
                                        <td>
                                            <a href="{{ route('admin.medicine.edit', $medicine->id) }}" class="btn btn-xs btn-outline-warning">
                                                <i class="fa fa-pencil"></i>&ensp;Edit</a>
                                            <a href="" class="btn btn-xs btn-outline-danger" data-toggle="modal"
                                               data-target="#deleteModal{{$medicine->id}}">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('admin.medicine.destroy', $medicine->id) }}"
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <b class="text-danger">{{ $medicine->name }}</b>"
                                                                    ?
                                                                </p>
                            ...
                            <div class="d-flex justify-content-center">
                                <p class="subtitle">Showing {{ $medicines->firstItem() }} - {{ $medicines->lastItem() }} of {{ $medicines->total() }} entries</p>
                            </div>
                        </div>
                    </div>
                </div>
